    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            */
            ...
            services.AddSwaggerGen(options => { options.SwaggerDoc("v1", new OpenApiInfo { Title = "DoctorApplicationMicroservice", Version = "v1" }); });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(options => options.SwaggerEndpoint("/swagger/v1/swagger.json", "DoctorApplicationMicroservice v1"));
            }
            /* AT
